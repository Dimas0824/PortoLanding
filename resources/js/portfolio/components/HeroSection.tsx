    ...
    <section className="relative pt-16 pb-10 px-4 md:px-6 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
            <motion.div
                ...
                className="absolute -top-24 -left-24 w-[34rem] h-[34rem] bg-[#F2C18D]/18 blur-3xl rounded-full"
            />
            <motion.div
                animate={{ scale: [1, 1.2, 1], x: [0, -50, 0] }}
                transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}
                className="absolute -bottom-24 right-[-10rem] w-[40rem] h-[40rem] bg-[#C2996B]/12 blur-3xl rounded-full"
            />
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-12 gap-10 items-center relative">
            ...
            >
                <div className="flex items-center gap-3 mb-6">
                    <motion.span
                        ...
                        className="h-[2px] bg-[#C2996B]"
                    />
                    <motion.span
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ duration: 0.5, delay: 0.8 }}
                        className="text-[#C2996B] text-[10px] font-black uppercase tracking-[0.4em]"
                    >
                        {profile.title}
                    </motion.span>
                </div>
                ...
                <motion.h1
                    ...
                    className="text-3xl md:text-5xl font-black tracking-tighter leading-[0.95] mb-6 max-w-3xl"
                >
                    {profile.name}
                    <br />
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4">
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            href="#contact"
                            className="bg-[#1A1A1A] text-white px-6 py-3 rounded-xl font-black uppercase tracking-[0.35em] text-[9px] hover:bg-[#F2C18D] hover:text-[#1A1A1A] transition-all flex items-center gap-2 shadow-lg group"
                        >
                        ...
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            href="#work"
                            className="bg-white/80 backdrop-blur border-2 border-[#1A1A1A] text-[#1A1A1A] px-6 py-3 rounded-xl font-black uppercase tracking-[0.35em] text-[9px] hover:bg-[#1A1A1A] hover:text-white transition-all flex items-center gap-2"
                        >
                    ...
                    <motion.div
                        ...
                        className="mt-8 flex items-center gap-3 text-[10px] text-gray-500"
                    >
                        <div className="flex items-center gap-2">
                            <span className="w-2 h-2 rounded-full bg-[#F2C18D] animate-ping" />
                            Available for new projects
                        </div>
                        <span className="opacity-40">•</span>
                        <div className="flex items-center gap-2">
                            <Star className="w-4 h-4 text-[#F2C18D] animate-pulse" />
            ...
            <motion.div
                ...
                className="hidden md:flex lg:col-span-5 relative items-center justify-center mt-10"
            >
                <div className="relative w-72 h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96 hover:scale-105 transition-transform duration-500">
                    <motion.div
                        ...
                        className="absolute -top-16 -left-16 w-[140%] h-[140%] opacity-40 scale-110 pointer-events-none"
                    >
                        <AbstractLines />
                    </motion.div>
