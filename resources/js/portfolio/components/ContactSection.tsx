                    ...
                    <div className="rounded-[26px] border border-[#1A1A1A]/12 bg-[#F9F7F5] p-7 md:p-9 shadow-sm">
                        ...
                        <form className="space-y-5" onSubmit={(event) => event.preventDefault()}>
                            ...
                            <div className="pt-2 flex items-center justify-between gap-4">
                                ...
                                <button
                                    type="submit"
                                    className="bg-[#1A1A1A] text-white px-7 py-3.5 rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-[#F2C18D] hover:text-[#1A1A1A] transition-all shadow-lg inline-flex items-center gap-3"
                                >
