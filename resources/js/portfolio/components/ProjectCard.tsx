...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => (
    <div className="group bg-white rounded-[16px] border border-[#E5E5E5] overflow-hidden hover:shadow-lg hover:border-[#F2C18D] transition-all duration-300 flex flex-col h-full">
