<header
    class="w-full max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6 relative bg-white dark:bg-[#161615] z-50 shadow mb-8 sm:mb-10 lg:mb-12">
    <nav class="flex items-center justify-between">
        <!-- Logo -->
        <a href="{{ route('home') }}" class="text-xl font-bold z-50 relative">
            Portofolio
        </a>
